...
export default function Agent() {
  ...
  return (
    <div className="bg-[#f7f7f8]">
      <div className="pt-6">
        <div className="mx-auto max-w-2xl px-4 py-6 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            <div className="bg-white p-6 sm:p-8">
              <h1 className="border-b py-4 text-xl">Featured Properties</h1>
              <PDRelated />
            </div>
          </div>
        </div>
