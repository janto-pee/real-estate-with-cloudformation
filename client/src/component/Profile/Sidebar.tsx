...
export default function Sidebar({ setActiveComponent }: SidebarInterface) {
  return (
          ...
          <ul className="pt-2 pb-4 space-y-1 text-sm">
            <li className="rounded-sm">
              <button
                ...
                onClick={() => {
                  setActiveComponent("profilesummary");
                }}
              >
                <svg
            ...
            <li className="rounded-sm">
              <button
                onClick={() => {
                  setActiveComponent("profileedit");
                }}
                className="flex items-center p-2 space-x-3 rounded-md"
              >
                <svg
